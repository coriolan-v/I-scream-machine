...
static constexpr uint32_t IDLE_TIMEOUT_MS       = 30000;   // Milliseconds of silence before idle kicks in.
...
void startupLedTest() {
  fillAll(rgb(120, 0, 0)); delay(400);
  fillAll(rgb(0, 120, 0)); delay(400);
  fillAll(rgb(0, 0, 120)); delay(400);
